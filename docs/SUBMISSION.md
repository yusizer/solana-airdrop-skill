...
- **Typed claim builder:** `examples/ts/claim_builder.ts` on `@solana/web3.js` 1.98.x — initialize + claim + gumdrop-claim instruction builders, PDA derivation, index-based verify helper — `tsc --noEmit` clean, typechecked in CI.
